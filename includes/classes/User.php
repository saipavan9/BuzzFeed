...
class User {
	...
	public function getFriendArray(){
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT friends_array FROM users WHERE username='$username'");
		$row = mysqli_fetch_array($query);
	...
	public function removeFriend($user_to_remove){
		...
		$remove_friend = mysqli_query($this->con, "UPDATE users SET friends_array='$new_friend_array' WHERE username='$logged_in_user'");

		$new_friend_array = str_replace($this->user['username'] . ",", "", $friend_array_username);
		$remove_friend = mysqli_query($this->con, "UPDATE users SET friends_array='$new_friend_array' WHERE username='$user_to_remove'");
	}
